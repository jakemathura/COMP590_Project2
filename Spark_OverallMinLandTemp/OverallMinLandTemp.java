...
public final class OverallMinLandTemp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.err.println("Usage: OverallMinLandTemp <input file> <output file>");
            System.exit(1);
        }
        ...
        JavaRDD<String> words = lines.flatMap(
                new FlatMapFunction<String, String>() {
                    ...
                    public Iterator<String> call(String s) {
                        ...
                        double minLandTemp = Integer.MAX_VALUE;
                        ...
                        try {
                            minLandTemp = Double.parseDouble(tokens[5]);
                        } catch (Exception e) {
                        }

                        String[] yearAndTemp = {year + " " + minLandTemp};
