...
public class CountryOverTimeMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		String countryplusdate = new String();
		...
		countryplusdate = country +"\t" +century;

		context.write(new Text(countryplusdate), new DoubleWritable(avgLandTemp));
