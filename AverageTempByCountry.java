...
public final class AverageTempByCountry {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.err.println("Usage: AverageTempByCountry <input file> <output file>");
            System.exit(1);
        }
        ...
        JavaRDD<String> words = lines.flatMap(
			...
			numYear = Double.parseDouble(year);
			country = tokens[3];			
			try{
                        ...
                        String[] country_temps = {country + " " + averageTemp};
                        return Arrays.asList(country_temps).iterator();
