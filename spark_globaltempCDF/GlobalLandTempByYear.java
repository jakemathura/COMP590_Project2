...
public final class GlobalLandTempByYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.err.println("Usage: GlobalLandTempByYear <input file> <output file>");
            System.exit(1);
        }
