...
public class RegularCityAvgTemp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(RegularCityAvgTemp.class);
    job.setJobName("CityCountryTemp");
    ...
    job.setMapperClass(RegularCityAvgTempMapper.class);
    job.setReducerClass(RegularCityAvgTempReducer.class);
