...
public final class MajorCityMaxTempSpark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2) {
            System.err.println("Usage: MajorCityMaxTempSpark <input file> <output file>");
            System.exit(1);
        }
        ...
        JavaRDD<String> words = lines.flatMap(
                new FlatMapFunction<String, String>() {
                    ...
                    public Iterator<String> call(String s) {
                        ...
                        double maxCityTemp = Integer.MIN_VALUE;
