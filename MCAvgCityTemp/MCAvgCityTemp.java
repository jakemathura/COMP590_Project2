...
public class MCAvgCityTemp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(MCAvgCityTemp.class);
    job.setJobName("Major City Avg City Temp");
    ...
    job.setMapperClass(MCAvgCityTempMapper.class);
    job.setReducerClass(MCAvgCityTempReducer.class);
