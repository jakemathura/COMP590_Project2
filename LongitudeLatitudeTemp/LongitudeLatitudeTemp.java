...
public class LongitudeLatitudeTemp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(LongitudeLatitudeTemp.class);
    job.setJobName("Longitude Latitude Temp");
    ...
    job.setMapperClass(LongitudeLatitudeTempMapper.class);
    job.setReducerClass(LongitudeLatitudeTempReducer.class);
