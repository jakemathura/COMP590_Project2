...
public class MajorCityAvgTemp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(MajorCityAvgTemp.class);
    job.setJobName("Major City Avg Temp");
    ...
    job.setMapperClass(MajorCityAvgTempMapper.class);
    job.setReducerClass(MajorCityAvgTempReducer.class);
